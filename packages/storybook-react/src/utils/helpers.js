function getTextColor(hue, saturation, lightness) {
    ...
    // Determinamos si el fondo es claro u oscuro basados en la saturacion y el brillo.
    const isLightColor = saturation > saturationThreshold || lightness > lightnessThreshold;
